...
<body>
    ...
    <form action="proses_edit.php" method="POST">
        ...
        <p>
            ...
            <label><input type="radio" name="kondisi" Value="baik"<?php echo $row['kondisi']?> />Baik</label>
            <label><input type="radio" name="kondisi" Value="rusak"<?php echo $row['kondisi']?> />Rusak</label>
        <p>
